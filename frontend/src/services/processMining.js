...
function runConformanceChecking(filteredCaseIds) {
  ...
  activeDeviationCases = {
    demo: new Set(),           // Omisión de Demo
    legal: new Set(),          // Contrato Grande sin Legal
    qualification: new Set(),  // Salto de Calificación
    rework: new Set()          // Bucle de Negociación
  };
